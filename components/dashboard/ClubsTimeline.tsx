...
const clubsData = [
	{
		...
		description: "Dive deep into AI and machine learning algorithms. Learn from experts and build real-world ML solutions.",
	},
	{
		id: 2,
		name: "Web Development Club",
		description: "Master modern web technologies (React, Next.js, Node.js). Build scalable web applications and learn best practices.",
	},
	{
		id: 3,
		name: "Cybersecurity Club",
		description: "Explore security vulnerabilities and ethical hacking. Learn to protect systems and data from threats.",
	},
	{
		id: 4,
		name: "Data Science Club",
		description: "Analyze complex datasets and extract meaningful insights. Learn data visualization and statistical analysis.",
	},
	{
		id: 5,
		name: "Cloud Computing Club",
		description: "Master AWS, Azure, and cloud architecture. Build scalable infrastructure and serverless applications.",
	},
];
