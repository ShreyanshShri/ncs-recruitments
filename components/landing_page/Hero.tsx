...
const Hero = ({ setLoadSite }: { setLoadSite: any }) => {
	...
	return (
		<div
			className={`min-h-screen w-full flex flex-col items-center justify-around text-center relative
      transition-opacity duration-700 ${loaded ? "opacity-100" : "opacity-0"}`}
		...
		>
			...
			{/* Content */}
			<div className="absolute top-[20%] lg:top-[24%] left-1/2 -translate-x-1/2 text-center">
				<h1 className="font-shuriken text-bd-dark text-4xl sm:text-4xl lg:text-5xl tracking-wider drop-shadow-[0_5px_15px_rgba(212,175,55,0.9)]">
					RECRUITMENT
				</h1>

				<h2 className="font-shuriken text-bg-dark text-3xl sm:text-4xl lg:text-5xl drop-shadow-[0_5px_15px_rgba(212,175,55,0.9)]">
					2026
				</h2>
			</div>
